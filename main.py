...
def solicitar_informacion_jugador():
    ...
    return user_name, num_players, user_position, blinds

if __name__ == "__main__":
    nombre_usuario, num_players, user_position, blinds = solicitar_informacion_jugador()
    game = PokerGame(nombre_usuario, num_players, user_position, blinds)
    game.start_game()
